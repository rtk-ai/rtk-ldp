...
const LANDING_ENTRIES: SearchEntry[] = [
  ...
  { id: 'cmd-gain', title: 'rtk gain — Token savings stats', keywords: 'gain stats savings tokens percentage history analytics report per-project', category: 'Commands', url: '/#proof', source: 'landing' },
